...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMark.setText(mWifiManager.isWifiEnabled() + "已完成坐标(" + String.valueOf(mXysp.getInt("x", 0)) + "," + String.valueOf(mXysp.getInt("y", 0)) + ")数据采集");
...
//                                    "ap_name text)";
                    ...
                    mMark.setText(mWifiManager.isWifiEnabled() + "已完成坐标(" + mApX.getText().toString() + "," + mApY.getText().toString() + ") " + mApDataList.size());
